...
images = glob.glob('../non-vehicles/myfalse/*.png')
for image in images:
    notcars.append(image)
images = glob.glob('../non-vehicles/myfalse2/*.png')
for image in images:
    notcars.append(image)
#    if 2000 < len(notcars):
#        break
...
images = glob.glob('../vehicles/myfalse/*.png')
for image in images:
    cars.append(image)
...
with open('svc_pickle.p', 'wb') as output:
    pickle.dump(dist_pickle, output, pickle.HIGHEST_PROTOCOL)

import solve
solve.saveRGB('34-out.jpg', window_img)
